...
//      NUMERO MAXIMO DE LINEAS EN MENU SON 16 (PARA MAS HACER SUBMENUS)
	...
	{MENU_ENTRY_CYCLE,(char *)st_machine,MENU_ACTION(3)},
	{MENU_ENTRY_CYCLE,(char *)st_joy,MENU_ACTION(2)},
...
//	LoadROM("ZX81    DAT");
	...
	while(1)
	{
		...
		dipsw |= (MENU_CYCLE_VALUE(&topmenu[4])  & 0x3) << 1;  //[2:1]
		dipsw |= (MENU_CYCLE_VALUE(&topmenu[5])  & 0x3) << 3;  //[4:3]
		dipsw |= (MENU_CYCLE_VALUE(&topmenu[6])  & 0x1) << 13; //[13]
